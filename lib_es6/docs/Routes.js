...
exports.default = (React.createElement(react_router_1.Route, { path: "/", component: PageRoot_1.default },
    React.createElement(react_router_1.IndexRoute, { component: IndexPage_1.default }),
    React.createElement(react_router_1.Route, { path: "/stage-demo", component: StageDemoPage_1.default })));
