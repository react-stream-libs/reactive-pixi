...
const Paper_1 = require("../../components/Graphics/Paper");
...
class IndexPage extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement(ReactWrapper_1.default, { ref: "reactWrapper" }),
            this.props.children,
            React.createElement("button", { onClick: () => this.rotateBy(15) }, "rotate!")));
    }
}
